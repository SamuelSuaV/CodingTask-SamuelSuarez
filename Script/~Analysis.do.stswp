 ...
 * Log GDP
 ...
 graph export "$output/log_gdp_capita_graph.pdf", as(pdf) replace
 ...
 * Log TFP
 ...
 graph export "$output/log_tfp_graph.pdf", as(pdf) replace
 ...
 graph export "$output/labsh_graph.pdf", as(pdf) replace
 ...
 * Cumulative GDP growth
 ...
 twoway ///
  ...
  graph export "$output/cumgrowth_gdp_capita_graph.pdf", as(pdf) replace
 ...
 twoway ///
  ...
  graph export "$output/cumgrowth_tfp_graph.pdf", as(pdf) replace
 ...
 graph export "$output/cumgrowth_labsh_graph.pdf", as(pdf) replace
 ...
 * Cumulative GDP vs TFP growth
  ...
  graph export "$output/cumgrowthgdp_ctfp_graph.pdf", as(pdf) replace
 ...
 * Cumulative labor share growth vs GDP per capita
  ...
  keep if cum_gr_cgdpo_capita >= r(c_1) & cum_gr_cgdpo_capita <= r(c_2) 
	...
	twoway ///
	  ...
	  graph export "$output/cumgrowthlabsh_gdp_graph.pdf", as(pdf) replace
